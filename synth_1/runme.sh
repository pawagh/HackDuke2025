...
HD_PWD='/home/noajam/Documents/comp541/Lab5/Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SoundAccel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SoundAccel.tcl
